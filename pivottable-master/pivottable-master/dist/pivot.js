  ...
  callWithJQuery(function($) {
    ...
    $.fn.pivotUI = function(input, inputOpts, overwrite, locale) {
      ...
      try {
        ...
        colList = $('<paper-material elevation="1"></paper-material>').addClass('pvtAxisContainer pvtUnused');
        ...
        $('<paper-material elevation="1"></paper-material>').addClass('pvtVals')
          .appendTo(tr1).append(aggregator).append($("<br>"));
        
        $('<paper-material elevation="1"></paper-material>').addClass('pvtAxisContainer pvtHorizList pvtCols').appendTo(tr1);
        tr2 = $('<div style="clear:both">').appendTo(uiTable);
        tr2.append($('<paper-material elevation="1"></paper-material>').addClass('pvtAxisContainer pvtRows').attr("valign", "top"));
